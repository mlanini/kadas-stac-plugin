...
- 🔍 22+ STAC catalogs (Planetary Computer, Copernicus, ESA, NASA, etc.)
...
1. Download: [`kadas_stac.1.1.2.zip`](https://github.com/mlanini/kadas-stac-plugin/releases/download/v1.1.2/kadas_stac.1.1.2.zip)
2. KADAS → **Plugins** → **Manage and Install Plugins** → **Install from ZIP**
3. Select ZIP → **Install Plugin**
